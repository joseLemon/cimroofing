                ...
                <div class="inside-content">
                    ...
                    <form method="POST" action="<?php echo home_url().'/'; ?>controller" id="inspection-form">
                        <div id="client">
                            ...
                            <input type="text" name="size-of-roof" id="size-of-roof" placeholder="Size of roof">ft&sup2;<br>
                            ...
                            &nbsp;Year manufactured:&nbsp;<input type="text" name="year-manufactured" id="year-manufactured" style="width:50px" value="<?php echo date('Y'); ?>"><br>
                            <input type="text" name="title" id="title" placeholder="Title">
                            Date of inspection:&nbsp; <input type="text" value="<?php echo date('H:i:s Y-m-d'); ?>" name="date" class="hidden datetimepicker"/><br>
                        ...
                        <div id="inspection-checklist">
                            ...
                            &nbsp;Programmed date:&nbsp; <input type="text" value="<?php echo date('H:i:s Y-m-d'); ?>" name="date-maintenance"  class="hidden datetimepicker"/><br>
                        ...
                        <div id="inspection-checklist-section">
                            ...
                            <table style="width:100%" id="checklist-table">
                                ...
                                <td><input type="text" name="observation-',$counter,'" id="observation',$counter,'" disabled></td>
                                <td><input type="date" name="daterepair-',$counter,'" id="daterepair',$counter,'" disabled></td></tr>';
