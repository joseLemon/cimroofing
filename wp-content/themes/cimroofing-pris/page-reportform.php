        ...
        <div id="reportform">
            ...
            <div class="general-content">
                ...
                <form method="POST" action="controller.php">
                    ...
                    <textarea class="textarea-coresample"></textarea>
                    ...
                    <table style="width:100%" class="glossary">
                        <tr class="glossary">
                            <td class="glossary"><text style="font-weight:600">A -</text> Access Hatch</td>
                            <td class="glossary"><text style="font-weight:600">D -</text> Roof Drain</td>
                            <td class="glossary"><text style="font-weight:600">G -</text> Gutter System</td>
                            <td class="glossary"><text style="font-weight:600">K -</text> Chimney</td>
                            <td class="glossary"><text style="font-weight:600">R -</text> Roof Vent</td>
                            <td class="glossary"><text style="font-weight:600">U -</text> HVAC Unit</td>
                        </tr>
                        <tr class="glossary">
                            <td class="glossary"><text style="font-weight:600">B -</text> Base Flashing</td>
                            <td class="glossary"><text style="font-weight:600">E -</text> Expansion Joint Cover</td>
                            <td class="glossary"><text style="font-weight:600">H -</text> Vent / Fan Hood</td>
                            <td class="glossary"><text style="font-weight:600">L -</text> Ladder</td>
                            <td class="glossary"><text style="font-weight:600">S -</text> Skylight</td>
                            <td class="glossary"><text style="font-weight:600">V -</text> Vent Pipe</td>
                        </tr>
                        <tr class="glossary">
                            <td class="glossary"><text style="font-weight:600">C -</text> Cap Flashing</td>
                            <td class="glossary"><text style="font-weight:600">F -</text> Fascia and Gravel Stop</td>
                            <td class="glossary"><text style="font-weight:600">J -</text> Flag Pole</td>
                            <td class="glossary"><text style="font-weight:600">P -</text> Parapet or Fire Wall</td>
                            <td class="glossary"><text style="font-weight:600">T -</text> Walkway</td>
                            <td class="glossary"><text style="font-weight:600">W -</text> Ponded Water</td>
                        </tr>
                    </table>
                        ...
                        <tr class="glossary">
                            <td class="glossary">
                                <div class="definition">
                                    ...
                                    <text style="margin-left:10px">Shrinkage cracking of the bituminous surface of built-up or smooth surface roofing, producing a pattern of deep cracks resembling an alligator hide.</text>
                                </div>
                            </td>
                            <td class="glossary">
                                <div class="definition">
                                    <text style="font-weight:700;font-size:19px">Fishmouth</text><br> 
                                    <text style="margin-left:10px">An opening of the lapped edge of applied felt in build-up roofing due to adhesion failure.</text>
                                </div>
                            </td>
                        </tr>
                        <tr class="glossary table-definitions">
                            <td class="glossary">
                                <div class="definition">
                                    ...
                                    <text style="margin-left:10px">A highly viscoushydrocarbon produced from the residium left after the distillation of petroleum; used as a waterproofing agent if a build-up roof.</text>
                                </div>
                            </td>
                            <td class="glossary">
                                <div class="definition">
                                    <text style="font-weight:700;font-size:19px">Flashing</text><br> 
                                    <text style="margin-left:10px">Connecting deviced that seal membrane joints, drains, gravel stops, and other places where membrane is interrupted. Base flashing forms the upturned edges of the wateright membrane. Cap or counter flashing shields the exposed edges and joints of the base flashing.</text>
                                </div>
                            </td>
                        </tr>
                        <tr class="glossary table-definitions">
                            <td class="glossary">
                                <div class="definition">
                                    ...
                                    <text style="margin-left:10px">An anchoring material (such as rock, gravel, pavers) used to resist wind and uplift forces of roof membrane.</text>
                                </div>
                            </td>
                            <td class="glossary">
                                <div class="definition">
                                    <text style="font-weight:700;font-size:19px">Gravel Stop</text><br> 
                                    <text style="margin-left:10px">Flanged device, normally metallic, designed to prevent loose aggregate from washing off roof. It also provides a finished edge detail for built-up roofing assembly.</text>
                                </div>
                            </td>
                        </tr>
                        <tr class="glossary table-definitions">
                            <td class="glossary">
                                <div class="definition">
                                    ...
                                    <text style="margin-left:10px">A generic term for asphalt or coal tar pitch roofing.</text>
                                </div>
                            </td>
                            <td class="glossary">
                                <div class="definition">
                                    <text style="font-weight:700;font-size:19px">High Risk Roof</text><br> 
                                    <text style="margin-left:10px">A roof which scores 15 or greater out of 20 using the Snow Overload Risk Assessment checklist.</text>
                                </div>
                            </td>
                        </tr>
                        <tr class="glossary table-definitions">
                            <td class="glossary">
                                <div class="definition">
                                    ...
                                    <text style="margin-left:10px">A spongyraised portion of roofing membrane as a result of pressure of entrapped air or water vapor.</text>
                                </div>
                            </td>
                            <td class="glossary">
                                <div class="definition">
                                    <text style="font-weight:700;font-size:19px">Modified Bitumen</text><br> 
                                    <text style="margin-left:10px">Asphalt with the addition of polymer modifiers to increase cold temperature flexibility and warm temperature flow resistance and stability.</text>
                                </div>
                            </td>
                        </tr>
                        <tr class="glossary table-definitions">
                            <td class="glossary">
                                <div class="definition">
                                    ...
                                    <text style="margin-left:10px">A continuous, semi-flexible roof covering consisting of laminations or plies of saturated or coated felts alternated with layers of bitumen.</text>
                                </div>
                            </td>
                            <td class="glossary">
                                <div class="definition">
                                    <text style="font-weight:700;font-size:19px">PVC</text><br> 
                                    <text style="margin-left:10px">A generic term for single ply plastic sheet membrane (poly vinyl chloride); seams are fused by solvent or hot-aire welding techniques.</text>
                                </div>
                            </td>
                        </tr>
                        <tr class="glossary table-definitions">
                            <td class="glossary">
                                <div class="definition">
                                    ...
                                    <text style="margin-left:10px">A continuous strip of triangular cross-section, fitted into the angle formed by a structural deck and a wall or other vertical surface, and used to provide gradual transition for base flashing and horizontal roof membrane.</text>
                                </div>
                            </td>
                            <td class="glossary">
                                <div class="definition">
                                    <text style="font-weight:700;font-size:19px">Parapet Ponding Slope</text><br> 
                                    <text style="margin-left:10px">The part of the wall entirely above the roof.<br>
                        ...
                        <tr class="glossary table-definitions">
                            <td class="glossary">
                                <div class="definition">
                                    ...
                                    <text style="margin-left:10px">A break in a roofing membrane as a result of flexing, often occurring at a ridge or wrinkle.</text>
                                </div>
                            </td>
                            <td class="glossary">
                                <div class="definition">
                                    <text style="font-weight:700;font-size:19px">Soffit</text><br> 
                                    <text style="margin-left:10px">The finish on the underside of a roof overhang.</text>
                                </div>
                            </td>
                        </tr>
                        <tr class="glossary table-definitions">
                            <td class="glossary">
                                <div class="definition">
                                    ...
                                    <text style="margin-left:10px">A synthethic rubber sheet used in single ply roof membrane (ethylene propylene diene monomer).</text>
                                </div>
                            </td>
                            <td class="glossary">
                                <div class="definition">
                                    <text style="font-weight:700;font-size:19px">TPO</text><br> 
                                    <text style="margin-left:10px">Thermoplastic polyolefins are in the thermoplastic elastometer family and are commonly referred to as TPO in the single-ply roofing industry.</text>
                                </div>
                            </td>
                        </tr>
                        <tr class="glossary table-definitions">
                            <td class="glossary">
                                <div class="definition">
                                    ...
                                    <text style="margin-left:10px">A deliberate separation of two roof areas to allows expansion and contraction movements of the parts.</text>
                                </div>
                            </td>
                            <td class="glossary">
                                <div class="definition">
                                    <text style="font-weight:700;font-size:19px">Fascia</text><br> 
                                    <text style="margin-left:10px">The finish membrane covering the edge or eaves of a flat or sloping roof or roof overhang .</text>
                                </div>
                            </td>
                        </tr>
                        <tr class="glossary table-definitions">
                            <td class="glossary">
                                <div class="definition">
                                    ...
                                    <text style="margin-left:10px">The protective overhang at the lower edge of a sloped roof.</text>
                                </div>
                            </td>
                        </tr>
                    </table>
