            ...
            <div class="general-content">
                <div class="inside-content">
                    ...
                    <form method="POST" action="<?php echo home_url().'/'; ?>controller" id="editinspection-form">
                        ...
                        <input type="text" name="slope" id="slope" placeholder="Slope" value="<?php echo $client->client_sloped; ?>"> &nbsp;in 12<br>
                        <input type="text" name="size-of-roof" id="size-of-roof" placeholder="Size of roof" value="<?php echo $client->client_size_of_roof; ?>">ft&sup2;<br>
                        ...
                        <div class="signature-canvas" style="margin-left:10px">
                            ...
                            <div class="canvas-area">
                                ...
                                <canvas id="signature"style="border: 1px solid black;margin-left:0px"></canvas>
                            </div>
